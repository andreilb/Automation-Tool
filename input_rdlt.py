...
#         self.Centers_list = self.contents['CENTER']
#         self.In_list = self.contents['IN']
#         self.Out_list = self.contents['OUT']
...
#         rdlts = [extract_rdlt(r) for r in rdlts_raw]
...
#             if R in dictionary:
#                 return dictionary[R]
#         return f"[WARNING] {R} has not been defined."

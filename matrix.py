...
This module provides matrix operations for analyzing the RDLT structure.
It offers a comprehensive set of operations to evaluate L-safeness.

Key operations performed:
1. Creation of matrix representation for RDLTs
2. Detection and analysis of cycles within the RDLT
3. Verification of safeness of critical arcs (CAs)
4. Evaluation of JOIN-safeness, checking split-join correctness
5. Loop-safeness analysis for non-critical arcs
6. Generation of violation reports for safety conditions

The Matrix class serves as the central component for RDLT analysis, providing methods to construct
and manipulate matrices that represent the structural properties.
"""
...
class Matrix:
    """
        This class models an RDLT and provides various methods to manipulate and analyze it. 
        The matrix operations are designed to check the L-safeness of a an RDLT.
        ...
        Attributes:
            ...
            all_ca_list: List of critical arcs in the RDLT.
            cycle_vector: Matrix used to store cycle-related data.
            out_cycle_vector: Matrix used for out-cycle verification.
            split_vector: Matrix used to track splits in the RDLT.
            join_vector: Matrix used to track joins in the RDLT.
    ...
    def join_safe(self):
        ...
        # Memoize paths to avoid recomputation
        path_cache = {}

        def find_all_paths(start, end, max_depth=10):
            """Memoized path finding with cycle prevention and depth limit"""
            cache_key = (start, end)
            ...
            while stack:
                ...
                for neighbor in vertex_outgoing.get(current, []):
    ...
    def print_matrix(self):
        ...
        columns_to_print = [0, 3, 5, 9, 11, 12]
